...
<span class="hljs-keyword">export</span> <span class="hljs-keyword">default</span> {
...
</code></pre></div><div class="van-doc-card"><h3 id="bi-tian-xing-hao" tabindex="-1">必填星号</h3><p>设置 <code>required</code> 属性来展示必填星号。</p><pre><code class="language-html"><span class="hljs-tag">&lt;<span class="hljs-name">van-cell-group</span> <span class="hljs-attr">inset</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">van-field</span>
  ...
  /&gt;</span>
<span class="hljs-tag">&lt;/<span class="hljs-name">van-cell-group</span>&gt;</span>
</code></pre><p>请注意 <code>required</code> 属性只用于控制样式展示，在进行表单校验时，需要使用 <code>rule.required</code> 选项来控制校验逻辑。</p></div><div class="van-doc-card"><h3 id="zi-dong-zhan-shi-xing-hao" tabindex="-1">自动展示星号</h3><p>你可以在 Form 组件上设置 <code>required=&quot;auto&quot;</code>，此时 Form 里的所有 Field 会自动根据 <code>rule.required</code> 来判断是否需要展示星号。</p><pre><code class="language-html"><span class="hljs-tag">&lt;<span class="hljs-name">van-form</span> <span class="hljs-attr">required</span>=<span class="hljs-string">&quot;auto&quot;</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">van-field</span>
    <span class="hljs-attr">v-model</span>=<span class="hljs-string">&quot;username&quot;</span>

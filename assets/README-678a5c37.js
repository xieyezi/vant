import{_ as s}from"./locales-1d12743b.js";import{o as a,a as t,z as e}from"./vue-libs-83dbabed.js";const n={},l={class:"van-doc-markdown-body"},o=e(`<h1>Highlight</h1><div class="van-doc-card"><h3 id="intro" tabindex="-1">Intro</h3><p>Highlight the specified text content. Please upgrade <code>vant</code> to &gt;= v4.8.0 before using this component.</p></div><div class="van-doc-card"><h3 id="install" tabindex="-1">Install</h3><p>Register component globally via <code>app.use</code>, refer to <a href="#/en-US/advanced-usage#zu-jian-zhu-ce" target="_blank">Component Registration</a> for more registration ways.</p><pre><code class="language-js"><span class="hljs-keyword">import</span> { createApp } <span class="hljs-keyword">from</span> <span class="hljs-string">&#39;vue&#39;</span>;
...
app.<span class="hljs-title function_">use</span>(<span class="hljs-title class_">Highlight</span>);
...
</code></pre></div><div class="van-doc-card"><h3 id="custom-class" tabindex="-1">Custom Class</h3><p>Set the <code>highlight-class-name</code> of the highlighted tag to customize the style.</p><pre><code class="language-html"><span class="hljs-tag">&lt;<span class="hljs-name">van-highlight</span>
  ...
  <span class="hljs-attr">highlight-class-name</span>=<span class="hljs-string">&quot;custom-class&quot;</span>
/&gt;</span>
</code></pre><pre><code class="language-ts"><span class="hljs-keyword">export</span> <span class="hljs-keyword">default</span> {
  <span class="hljs-title function_">setup</span>(<span class="hljs-params"></span>) {
    <span class="hljs-keyword">const</span> text =
...
</code></pre></div><h2 id="api" tabindex="-1">API</h2><div class="van-doc-card"><h3 id="props" tabindex="-1">Props</h3><table><thead><tr><th>Attribute</th><th>Description</th><th>Type</th><th>Default</th></tr></thead><tbody><tr><td>keywords</td><td>Expected highlighted text</td><td><em>string | string[]</em></td><td>-</td></tr><tr><td>source-string</td><td>Source text</td><td><em>string</em></td><td>-</td></tr><tr><td>auto-escape</td><td>Whether to automatically escape</td><td><em>boolean</em></td><td><code>true</code></td></tr><tr><td>case-sensitive</td><td>Is case sensitive</td><td><em>boolean</em></td><td><code>false</code></td></tr><tr><td>highlight-class-name</td><td>Class name of the highlight tag</td><td><em>string</em></td><td>-</td></tr></tbody></table></div><div class="van-doc-card"><h3 id="types" tabindex="-1">Types</h3><p>The component exports the following type definitions:</p><pre><code class="language-ts"><span class="hljs-keyword">import</span> <span class="hljs-keyword">type</span> { <span class="hljs-title class_">HighlightProps</span>, <span class="hljs-title class_">HighlightThemeVars</span> } <span class="hljs-keyword">from</span> <span class="hljs-string">&#39;vant&#39;</span>;
</code></pre></div><h2 id="theming" tabindex="-1">Theming</h2><div class="van-doc-card"><h3 id="css-variables" tabindex="-1">CSS Variables</h3><p>The component provides the following CSS variables, which can be used to customize styles. Please refer to <a href="#/en-US/config-provider" target="_blank">ConfigProvider component</a>.</p><table><thead><tr><th>Name</th><th>Default Value</th><th>Description</th></tr></thead><tbody><tr><td>--van-highlight-tag-color</td><td><em>var(--van-primary-color)</em></td><td>Color of highlighted text</td></tr></tbody></table></div>`,12),p=[o];function c(r,d){return a(),t("div",l,p)}const g=s(n,[["render",c]]);export{g as default};

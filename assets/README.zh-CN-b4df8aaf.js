...
</code></pre></div><div class="van-doc-card"><h3 id="she-zhi-gao-liang-biao-qian-lei-ming" tabindex="-1">设置高亮标签类名</h3><p>通过 <code>highlight-class-name</code> 可以设置高亮标签的类名，以便自定义样式。</p><pre><code class="language-html"><span class="hljs-tag">&lt;<span class="hljs-name">van-highlight</span>
...
</code></pre></div><h2 id="api" tabindex="-1">API</h2><div class="van-doc-card"><h3 id="props" tabindex="-1">Props</h3><table><thead><tr><th>参数</th><th>说明</th><th>类型</th><th>默认值</th></tr></thead><tbody><tr><td>keywords</td><td>期望高亮的文本</td><td><em>string | string[]</em></td><td>-</td></tr><tr><td>source-string</td><td>源文本</td><td><em>string</em></td><td>-</td></tr><tr><td>auto-escape</td><td>是否自动转义</td><td><em>boolean</em></td><td><code>true</code></td></tr><tr><td>case-sensitive</td><td>是否区分大小写</td><td><em>boolean</em></td><td><code>false</code></td></tr><tr><td>highlight-class-name</td><td>高亮标签的类名</td><td><em>string</em></td><td>-</td></tr></tbody></table></div><div class="van-doc-card"><h3 id="lei-xing-ding-yi" tabindex="-1">类型定义</h3><p>组件导出以下类型定义：</p><pre><code class="language-ts"><span class="hljs-keyword">import</span> <span class="hljs-keyword">type</span> { <span class="hljs-title class_">HighlightProps</span>, <span class="hljs-title class_">HighlightThemeVars</span> } <span class="hljs-keyword">from</span> <span class="hljs-string">&#39;vant&#39;</span>;
</code></pre></div><h2 id="zhu-ti-ding-zhi" tabindex="-1">主题定制</h2><div class="van-doc-card"><h3 id="yang-shi-bian-liang" tabindex="-1">样式变量</h3><p>组件提供了下列 CSS 变量，可用于自定义样式，使用方法请参考 <a href="#/zh-CN/config-provider" target="_blank">ConfigProvider 组件</a>。</p><table><thead><tr><th>名称</th><th>默认值</th><th>描述</th></tr></thead><tbody><tr><td>--van-highlight-tag-color</td><td><em>var(--van-primary-color)</em></td><td>高亮文本颜色</td></tr></tbody></table></div>`,12),d=[p];function c(r,o){return a(),n("div",l,d)}const g=s(e,[["render",c]]);export{g as default};

import{_ as s}from"./locales-1d12743b.js";import{o as a,a as n,z as t}from"./vue-libs-83dbabed.js";const e={},l={class:"van-doc-markdown-body"},p=t(`<h1>useCustomFieldValue</h1><div class="van-doc-card"><h3 id="intro" tabindex="-1">Intro</h3><p>Used to custom Field value.</p></div><h2 id="usage" tabindex="-1">Usage</h2><div class="van-doc-card"><h3 id="basic-usage" tabindex="-1">Basic Usage</h3><p>If you want to custom Form items, you can insert your component into the <code>input</code> slot of the Field component, and call the <code>useCustomFieldValue</code> method inside your custom component.</p><h4 id="mycomponent" tabindex="-1">MyComponent</h4><pre><code class="language-js"><span class="hljs-comment">// MyComponent.vue</span>
...
</code></pre></div><div class="van-doc-card"><h3 id="params" tabindex="-1">Params</h3><table><thead><tr><th>Name</th><th>Description</th><th>Type</th><th>Default Value</th></tr></thead><tbody><tr><td>customValue</td><td>Function to get field value</td><td><em>() =&gt; unknown</em></td><td>-</td></tr></tbody></table></div>`,7),o=[p];function c(d,i){return a(),n("div",l,o)}const u=s(e,[["render",c]]);export{u as default};

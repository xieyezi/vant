import{_ as s}from"./locales-1d12743b.js";import{o as a,a as n,z as t}from"./vue-libs-83dbabed.js";const e={},l={class:"van-doc-markdown-body"},i=t(`<h1>useWindowSize</h1><div class="van-doc-card"><h3 id="intro" tabindex="-1">Intro</h3><p>Get the viewport width and height of the browser window, and update it automatically when the window size changes.</p></div><h2 id="usage" tabindex="-1">Usage</h2><div class="van-doc-card"><h3 id="basic-usage" tabindex="-1">Basic Usage</h3><pre><code class="language-js"><span class="hljs-keyword">import</span> { watch } <span class="hljs-keyword">from</span> <span class="hljs-string">&#39;vue&#39;</span>;
...
</code></pre></div><div class="van-doc-card"><h3 id="return-value" tabindex="-1">Return Value</h3><table><thead><tr><th>Name</th><th>Description</th><th>Type</th></tr></thead><tbody><tr><td>width</td><td>The width of browser window</td><td><em>Ref&lt;number&gt;</em></td></tr><tr><td>height</td><td>The height of browser window</td><td><em>Ref&lt;number&gt;</em></td></tr></tbody></table></div>`,7),o=[i];function c(p,d){return a(),n("div",l,o)}const w=s(e,[["render",c]]);export{w as default};

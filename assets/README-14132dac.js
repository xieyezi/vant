import{_ as s}from"./locales-1d12743b.js";import{o as a,a as t,z as e}from"./vue-libs-83dbabed.js";const n={},l={class:"van-doc-markdown-body"},p=e(`<h1>Uploader</h1><div class="van-doc-card"><h3 id="intro" tabindex="-1">Intro</h3><p>Used to upload a local image or file to the server and display a preview image and upload progress during the upload process. The Uploader component does not currently contain the interface logic for uploading files to the server, this step needs to be implemented by the user.</p></div><div class="van-doc-card"><h3 id="install" tabindex="-1">Install</h3><p>Register component globally via <code>app.use</code>, refer to <a href="#/en-US/advanced-usage#zu-jian-zhu-ce" target="_blank">Component Registration</a> for more registration ways.</p><pre><code class="language-js"><span class="hljs-keyword">import</span> { createApp } <span class="hljs-keyword">from</span> <span class="hljs-string">&#39;vue&#39;</span>;
...
</code></pre></div><div class="van-doc-card"><h3 id="enable-reupload" tabindex="-1">Enable Reupload</h3><pre><code class="language-html"><span class="hljs-tag">&lt;<span class="hljs-name">van-uploader</span> <span class="hljs-attr">v-model</span>=<span class="hljs-string">&quot;fileList&quot;</span> <span class="hljs-attr">reupload</span> <span class="hljs-attr">max-count</span>=<span class="hljs-string">&quot;2&quot;</span> /&gt;</span>
...
</code></pre></div>`,28),d=[p];function r(o,c){return a(),t("div",l,d)}const m=s(n,[["render",r]]);export{m as default};

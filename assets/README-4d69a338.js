import{_ as s}from"./locales-1d12743b.js";import{o as a,a as t,z as n}from"./vue-libs-83dbabed.js";const l={},e={class:"van-doc-markdown-body"},p=n(`<h1>Popover</h1><div class="van-doc-card"><h3 id="intro" tabindex="-1">Intro</h3><p>Used to display some content on top of another.</p></div><div class="van-doc-card"><h3 id="install" tabindex="-1">Install</h3><p>Register component globally via <code>app.use</code>, refer to <a href="#/en-US/advanced-usage#zu-jian-zhu-ce" target="_blank">Component Registration</a> for more registration ways.</p><pre><code class="language-js"><span class="hljs-keyword">import</span> { createApp } <span class="hljs-keyword">from</span> <span class="hljs-string">&#39;vue&#39;</span>;
...
</code></pre></div><div class="van-doc-card"><h3 id="horizontal" tabindex="-1">Horizontal</h3><p>After setting the <code>actions-direction</code> prop to <code>horizontal</code>, the actions will be arranged horizontally.</p><pre><code class="language-html"><span class="hljs-tag">&lt;<span class="hljs-name">van-popover</span>

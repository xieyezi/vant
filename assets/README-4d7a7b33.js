import{_ as s}from"./locales-1d12743b.js";import{o as a,a as t,z as n}from"./vue-libs-83dbabed.js";const l={},e={class:"van-doc-markdown-body"},d=n(`<h1>Field</h1><div class="van-doc-card"><h3 id="intro" tabindex="-1">Intro</h3><p>Field component let users enter and edit text.</p></div><div class="van-doc-card"><h3 id="install" tabindex="-1">Install</h3><p>Register component globally via <code>app.use</code>, refer to <a href="#/en-US/advanced-usage#zu-jian-zhu-ce" target="_blank">Component Registration</a> for more registration ways.</p><pre><code class="language-js"><span class="hljs-keyword">import</span> { createApp } <span class="hljs-keyword">from</span> <span class="hljs-string">&#39;vue&#39;</span>;
...
</code></pre></div><div class="van-doc-card"><h3 id="required" tabindex="-1">Required</h3><p>Use the <code>required</code> prop to display a required asterisk.</p><pre><code class="language-html"><span class="hljs-tag">&lt;<span class="hljs-name">van-cell-group</span> <span class="hljs-attr">inset</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">van-field</span>
...
<span class="hljs-tag">&lt;/<span class="hljs-name">van-cell-group</span>&gt;</span>
</code></pre><p>Please note that the <code>required</code> prop is only used for controlling the style. For form validation, you need to use the <code>rule.required</code> option to control the validation logic.</p></div><div class="van-doc-card"><h3 id="auto-required" tabindex="-1">Auto Required</h3><p>You can set <code>required=&quot;auto&quot;</code> on the Form component, and all the fields inside the Form will automatically display the asterisk based on the <code>rule.required</code> option.</p><pre><code class="language-html"><span class="hljs-tag">&lt;<span class="hljs-name">van-form</span> <span class="hljs-attr">required</span>=<span class="hljs-string">&quot;auto&quot;</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">van-field</span>
    <span class="hljs-attr">v-model</span>=<span class="hljs-string">&quot;username&quot;</span>

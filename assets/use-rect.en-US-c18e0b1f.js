import{_ as t}from"./locales-1d12743b.js";import{o as s,a as e,z as n}from"./vue-libs-83dbabed.js";const a={},o={class:"van-doc-markdown-body"},l=n(`<h1>useRect</h1><div class="van-doc-card"><h3 id="intro" tabindex="-1">Intro</h3><p>Get the size of an element and its position relative to the viewport, equivalent to <a href="https://developer.mozilla.org/en-US/docs/Web/API/Element/getBoundingClientRect" target="_blank">Element.getBoundingClientRect</a>.</p></div><h2 id="usage" tabindex="-1">Usage</h2><div class="van-doc-card"><h3 id="basic-usage" tabindex="-1">Basic Usage</h3><pre><code class="language-html"><span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">ref</span>=<span class="hljs-string">&quot;root&quot;</span> /&gt;</span>
...
</code></pre></div><div class="van-doc-card"><h3 id="return-value" tabindex="-1">Return Value</h3><table><thead><tr><th>Name</th><th>Description</th><th>Type</th></tr></thead><tbody><tr><td>width</td><td>Width of the element</td><td><em>number</em></td></tr><tr><td>height</td><td>Height of the element</td><td><em>number</em></td></tr><tr><td>top</td><td>The distance from the top to the top-left of the viewport</td><td><em>number</em></td></tr><tr><td>left</td><td>The distance from the left to the top-left of the viewport</td><td><em>number</em></td></tr><tr><td>right</td><td>The distance from the right to the top-left of the viewport</td><td><em>number</em></td></tr><tr><td>bottom</td><td>The distance from the bottom to the top-left of the viewport</td><td><em>number</em></td></tr></tbody></table></div>`,7),d=[l];function r(c,p){return s(),e("div",o,d)}const m=t(a,[["render",r]]);export{m as default};
